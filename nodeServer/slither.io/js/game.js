...
class game {
    ...
    getGameState() {
        return {
            ...
            snakes: this.mySnake.map(snake => ({
                name: snake.name,
                score: snake.score,
                body: snake.v.map(segment => ({ x: segment.x, y: segment.y })),
                direction: { dx: snake.dx, dy: snake.dy },
                speed: snake.speed,
            })),
            ...
            backgroundImage: this.bg_im, // If needed for rendering
            gameStatus: {
                isRunning: !this.die,
            },
        };
